...
ActiveRecord::Schema.define(version: 20140308003231) do
  ...
  add_index "friendships", ["out_friend_id", "in_friend_id"], name: "index_friendships_on_out_friend_id_and_in_friend_id", unique: true, using: :btree
